...
- 当前变更：[dshjob-static-site-v1](openspec/changes/dshjob-static-site-v1/proposal.md)。Spec 已完成并通过严格校验；2026-09-15 已获实施授权（见上条，原话与范围已记录），当前处于本地实施与验证阶段。推送、发布、上线仍需单独授权；不将“视觉认可”记为 PRD 已批准。
